        ...
        var endpoints = {
            ...
            setGroupDefaultInterjections: function (request, response) {
                ...
                return GroupInterjectionModel.bulkCreate([
                    ...
                    {groupID:groupId, Position:0, Title: 'Done Communicating!', Description: 'Done Communicating!', Icon:'fa fa-volume-off', BackgroundColor:'#BF5FFF',TextColor:'#fff',IncludeCaptionist:true,IncludeInterpreter:true,IsActive:true,Sound:'beep-07'},
